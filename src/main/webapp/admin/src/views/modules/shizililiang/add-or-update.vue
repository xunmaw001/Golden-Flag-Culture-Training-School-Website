    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="教师介绍" prop="jiaoshijieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoshijieshao" label="教师介绍" prop="jiaoshijieshao">
                    <span>{{ruleForm.jiaoshijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
