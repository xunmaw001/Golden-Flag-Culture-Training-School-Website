...
import center from '@/views/center'
    ...
    import kechengjieshao from '@/views/modules/kechengjieshao/list'
    import kechengyuyue from '@/views/modules/kechengyuyue/list'
    import xianshangjiaoxueziyuan from '@/views/modules/xianshangjiaoxueziyuan/list'
...
const routes = [{
	...
	path: '/kechengyuyue',
      ...
      ,{
	path: '/xianshangjiaoxueziyuan',
        name: '线上教学资源',
        component: xianshangjiaoxueziyuan
      }
      ,{
	path: '/xuexiaojianjie',
        name: '学校简介',
